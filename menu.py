...
class obj_scene_titlescreen(page.obj_page):
    ...
    def presetup(self):
        ...
        self.sprite_ch1=draw.obj_textbox('Day 1: The Hero',(640,440),fontsize='smaller')
        self.sprite_ch2=draw.obj_textbox('Day 2: The Partner',(640,470),fontsize='smaller')
        self.sprite_ch3=draw.obj_textbox('Day 3: The Villain',(640,500),fontsize='smaller')
