...
class obj_scene_chapter1(utils.obj_page):
    def setup(self):
        ...
        self.addpart( draw.obj_textinput('heroname',25,(650,260),color=share.colors.hero, legend='Hero Name') )
    def nextpage(self):
...
class obj_scene_ch1p1(utils.obj_page):
    def setup(self):         
        self.text=['In the beginning, ',('{heroname}',share.colors.hero),\
                   ' the Hero was only a mere pair of legs because he was built from the ground up.',\
...
class obj_scene_ch1p3(utils.obj_page):
    def setup(self):       
        ...
        textbox=draw.obj_textbox('Move with [arrows] or [WASD]',(640,680),fontsize='large')
        hero.addpart("instructions",textbox)
...
class obj_scene_ch1p7(utils.obj_page):
    def setup(self):        
        ...
        hero=actor.obj_actor_hero_v3(self.world,(640,360))# Hero in world
        hero.scale(0.5)
...
class obj_scene_ch1p8(utils.obj_page):
    def setup(self):        
        ...
        self.addpart( draw.obj_image('herohead_angry',(240,410)) )
        self.addpart( draw.obj_image('herolegs_stand',(240,570)) )
...
class obj_scene_ch1p9(utils.obj_page):
    def setup(self):        
        ...
        hero.addpart("instructions", draw.obj_textbox('Strike with [Left Mouse] or [Space]',(640,680),fontsize='huge') )
