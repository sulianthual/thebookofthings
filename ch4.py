...
class obj_scene_ch4p10a(page.obj_chapterpage):
    ...
    def setup(self):
        ...
        self.text=['"The forest was in 3D with next generation graphics." ',\
...
class obj_scene_ch4p16gdeath(page.obj_chapterpage):
    ...
    def nextpage(self):
        if share.devmode or share.datamanager.getword('choice_yesno')=='yes':
            ...
            share.scenemanager.switchscene(obj_scene_ch4p16i())# skip
    def textboxset(self):
        self.textboxopt={'xy':(640,280),'text':'[confirm]','align':'center'}
    def setup(self):
        self.text=[\
...
class obj_scene_ch4p16i(page.obj_chapterpage):
    ...
    def setup(self):
        ...
        # self.addpart(draw.obj_imageplacer(self,'tree','bush','sun','cave'))
        ...
        self.addpart( draw.obj_image('sun',(1073,176),scale=0.41,rotate=0,fliph=True,flipv=False) )
...
class obj_scene_ch4p16o(page.obj_chapterpage):
    ...
    def setup(self):
        self.text=[\
                ...
                ('"fight"',share.colors.password),', now go away.',\
                   ]
...
class obj_scene_ch4end(page.obj_chapterpage):
    ...
    def setup(self):
        self.text=[\
                   ...
                   'Only two grandmasters to go, lets see what happens tomorrow. ',\
                   ]
