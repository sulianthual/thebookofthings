...
class obj_scene_ch7p1(page.obj_chapterpage):
    ...
    def setup(self):
        ...
        # self.addpart( draw.obj_image('towersparks',(754,418-60),scale=0.8,path='data/premade') )
...
class obj_scene_ch7p19(page.obj_chapterpage):# NB: jump to here from first password input in chapt 7
    ...
    def setup(self):
        ...
        self.text=[\
                ...
                'Ugh, that is correct, said the tower\'s a.s.s., how did you figure it out. ',\
                'Well, You may now enter". ',\
...
class obj_scene_ch7p21(page.obj_chapterpage):
    ...
    def setup(self):
        self.text=[\
                  '"',\
                    'Well well, you have finally figured out my password, ',\
